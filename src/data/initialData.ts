...
export const INITIAL_STUDY_MATERIALS: StudyMaterial[] = [
  {
    ...
    subject: 'Wellness Coaching',
    chapter: 'Book 1: Introduction to Wellness Coaching',
    pages: 45,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1840,
    previewContent: 'Comprehensive introduction to professional wellness coaching, consultation foundations, ethical scope of practice, and client empowerment models.'
  },
  {
    id: 'mat-book-2',
    ...
    targetClass: 'WCNA Program',
    subject: 'Naturopathy',
    chapter: 'Book 2: Fundamentals of Naturopathy',
    pages: 52,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1650,
    previewContent: 'Five elements theory (Pancha Mahabhuta), vital force principles, hydrotherapy, mud therapy, and natural detoxification healing mechanisms.'
  },
  {
    id: 'mat-book-3',
    ...
    targetClass: 'WCNA Program',
    subject: 'Ayurveda',
    chapter: 'Book 3: Fundamentals of Ayurveda',
    pages: 58,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1920,
    previewContent: 'Tridosha analysis (Vata, Pitta, Kapha), Sapta Dhatus, Agni (digestive fire), Prakriti diagnosis, and foundational Ayurvedic pharmacology.'
  },
  {
    id: 'mat-book-4',
    title: 'Book 4: Human Anatomy (Coming Soon)',
    category: 'pdf_notes',
    targetClass: 'WCNA Program',
    ...
    downloadsCount: 890,
    previewContent: 'Structural overview of organ systems, circulatory and endocrine pathways, nervous system, and physiological mechanisms in holistic health (in preparation).'
  },
  {
    id: 'mat-book-5',
    ...
    chapter: 'Book 5: Client Intake & Diagnostic Assessment',
    pages: 48,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1430,
    previewContent: 'Standard intake forms, Nadi Pariksha protocols, tongue and eye observation, lifestyle questionnaire analysis, and wellness goal mapping.'
  },
  {
    id: 'mat-book-6',
    ...
    chapter: 'Book 6: Therapeutic Dietetics & Nutrition Planning',
    pages: 56,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
  ...
  },
  {
    ...
    chapter: 'Book 7: Dinacharya & Circadian Rhythms',
    pages: 42,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1780,
    previewContent: 'Dinacharya (daily regimen), Ratricharya (night routine), sleep hygiene, stress reduction techniques, and sustainable habit formation.'
  },
  {
    id: 'mat-book-8',
    ...
    category: 'pdf_notes',
    targetClass: 'WCNA Program',
    subject: 'Therapeutic Case Management',
    chapter: 'Book 8: Metabolic & Lifestyle Disorders',
    pages: 64,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 2350,
    previewContent: 'Naturopathic and Ayurvedic management protocols for hypertension, type-2 diabetes, obesity, thyroid dysfunction, and chronic acidity.'
  },
  {
    id: 'mat-book-9',
    ...
    chapter: 'Book 9: Pharmacopeia & Nutritional Supplements',
    pages: 50,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1980,
    previewContent: 'Essential healing herbs (Ashwagandha, Giloy, Triphala, Brahmi), herbal decoction methods, safety margins, contraindications, and supplement guidance.'
  },
  {
    id: 'mat-book-10',
    ...
    chapter: 'Book 10: Client Communication & Coaching Skills',
    pages: 46,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
    ...
    downloadsCount: 1560,
    previewContent: 'Empathetic listening, motivational interviewing, non-violent communication, handling client resistance, progress tracking, and professional consultancy ethics.'
  },
  {
    id: 'mat-wcfm-1',
    ...
    chapter: 'Module 1: Corporate Valuation',
    pages: 48,
    downloadUrl: '#',
    isPremium: true,
    fileType: 'pdf',
  ...
  },
  {
    ...
    chapter: 'Module 2: Portfolio Strategy',
    pages: 32,
    downloadUrl: '#',
    isPremium: false,
    fileType: 'pdf',
